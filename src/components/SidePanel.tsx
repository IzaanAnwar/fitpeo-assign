...
const SidePanel = () => {
  return (
    <div className="text-sm w-1/2 md:w-[24%] lg:w-[20%] bg-accent-primary min-h-screen text-left text-light-text-sc p-4 flex flex-col justify-between">
      <div>
        ...
        <div className="flex justify-start items-center py-2 rounded-md px-4 hover:bg-accent-hover hover:text-light-text-pr duration-100 ">
          <DashboardIcon />
        ...
        <div className="flex justify-start py-2 rounded-md px-4 hover:bg-accent-hover hover:text-light-text-pr duration-100">
          <ProductsIcon />
          <a href="#" className="px-2">
            Products
          </a>
      ...
      <div className="rounded-md px-4 py-2 flex justify-start items-center hover:bg-accent-hover hover:text-light-text-pr duration-100">
        <img
          src="/dummy-usr.png"
          alt="User"

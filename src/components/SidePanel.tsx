    ...
    return (
        <div className="text-sm w-1/2 md:w-[20%] bg-accent-primary min-h-screen text-left text-light-text-sc p-4 flex flex-col justify-between">
            <div>
                ...
                <div className="flex justify-start items-center py-2 rounded-md px-4 hover:bg-accent-hover focus:bg-accent-primary">
                    <DashboardIcon />
            ...
            <div className="rounded-md px-4 py-2 flex justify-start items-center hover:bg-accent-hover">
                <img
                    src="/dummy-usr.png"
                    alt="User"
                    className="rounded-full w-[20%] md:w-[16%] h-[20%] md:h-[16%]"
                />
                <div className="px-4">
                    <h6 className="font-semibold text-light-text-pr">Evanto</h6>
                    <p className="text-light-text-sc">Project Manager</p>
                </div>
            </div>
        </div>
    );
